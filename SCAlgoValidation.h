...
vector<vector<double>> *superCluster_sim_fraction;
...
vector<vector<double>> *deepSuperCluster_sim_fraction;
...
TBranch *b_superCluster_sim_fraction;
...
TBranch *b_deepSuperCluster_sim_fraction;
...
void setTreeBranches(TTree* tree, std::string superClusterRef, std::string superClusterVal)
{
   ...
   tree->SetBranchStatus(std::string(superClusterRef+"_sim_fraction").c_str(),1);
   tree->SetBranchStatus(std::string(superClusterVal+"_dR_genScore").c_str(),1);
   tree->SetBranchStatus(std::string(superClusterVal+"_sim_fraction").c_str(),1);
   ...
   //tree->SetBranchAddress(std::string(superClusterRef+"_sim_fraction").c_str(), &superCluster_sim_fraction, &b_superCluster_sim_fraction);
   ...
   tree->SetBranchAddress(std::string(superClusterVal+"_sim_fraction").c_str(), &deepSuperCluster_sim_fraction, &b_deepSuperCluster_sim_fraction);
...
std::pair<std::vector<int>,std::vector<int>> matchParticles(std::map<int,std::map<int,double>>* Calo_SC_sim_fraction, std::map<int,std::map<int,double>>* SC_Calo_sim_fraction)
{ 
   vector<int> calo_superCluster_MatchedIndex; 
   for(auto const& calo : *Calo_SC_sim_fraction)
   {
      int max = 0; 
      bool notZero = false;
   ...
   for(auto const& SC : *SC_Calo_sim_fraction)
   {
      int max = 0; 
      bool notZero = false;
...
void setHistograms(std::vector<std::pair<std::string,std::vector<double>>> binOpts, std::vector<float> etCuts, std::vector<float> etaCuts)
{
   ...
   h_calo_pfClusters_eta = new TH1F("PFClusters_Calo","",60,-3,3);
   h_sc_pfClusters_eta_new = new TH1F("PFClusters_SC_New","",60,-3,3);
   h_sc_pfClusters_eta_old = new TH1F("PFClusters_SC_Old","",60,-3,3);
   h_sc_pfClusters_caloInSC_new = new TH1F("PFClusters_SC_caloInSC_New","",60,-3,3);
   h_sc_pfClusters_caloInSC_old = new TH1F("PFClusters_SC_caloInSC_Old","",60,-3,3);


   h_Eta_SC_old = new TH1F("h_Eta_SC_old","",60,-3,3);
   h_Eta_SC_new = new TH1F("h_Eta_SC_new","",60,-3,3);
   h_Eta_SCGen_old = new TH1F("h_Eta_SCGen_old","",60,-3,3);
   h_Eta_SCGen_new = new TH1F("h_Eta_SCGen_new","",60,-3,3);
   h_Eta_SC_old_dr = new TH1F("h_Eta_SC_old_dr","",60,-3,3);
   h_Eta_SC_new_dr = new TH1F("h_Eta_SC_new_dr","",60,-3,3);
   h_Eta_SCGen_old_dr = new TH1F("h_Eta_SCGen_old_dr","",60,-3,3);
   h_Eta_SCGen_new_dr = new TH1F("h_Eta_SCGen_new_dr","",60,-3,3);
   h_Eta_Gen_Denum = new TH1F("h_Eta_Gen_Denum","",60,-3,3);
   h_Eta_Calo_Denum_2 = new TH1F("h_Eta_Calo_Denum_2","",60,-3,3);
   h_caloPT_vs_Eta_new = new TH2F("h_caloPT_vs_Eta_new","",60,-3,3,200,0,100);
   h_caloPT_vs_Eta_old = new TH2F("h_caloPT_vs_Eta_old","",60,-3,3,200,0,100);
   //h_Eta_SCGen_old = new TH1F("h_Eta_SCGen_old","",60,-3,3);
   //h_Eta_SCGen_new = new TH1F("h_Eta_SCGen_new","",60,-3,3);
   ...
   int nBins_EtaWidth_EB = binOpts[findOption(std::string("EtaWidthBins_Barrel"),binOpts)].second[0]; 
   int nBins_EtaWidth_EE = binOpts[findOption(std::string("EtaWidthBins_Endcap"),binOpts)].second[0];
   
   EoEtrue_vs_EtaWidth_EB_old.resize(nBins_EtaWidth_EB);
   for(int iBin=0; iBin<nBins_EtaWidth_EB; iBin++)
       EoEtrue_vs_EtaWidth_EB_old[iBin] = new TH1F(std::string("EoEtrue_vs_EtaWidth_EB_old_"+to_string(iBin)).c_str(), std::string("EoEtrue_vs_EtaWidth_EB_old_"+to_string(iBin)).c_str(), 10000, 0., 10.);
   EoEtrue_vs_EtaWidth_EB_new.resize(nBins_EtaWidth_EB);
   for(int iBin=0; iBin<nBins_EtaWidth_EB; iBin++)
       EoEtrue_vs_EtaWidth_EB_new[iBin] = new TH1F(std::string("EoEtrue_vs_EtaWidth_EB_new_"+to_string(iBin)).c_str(), std::string("EoEtrue_vs_EtaWidth_EB_new_"+to_string(iBin)).c_str(), 10000, 0., 10.);
   
   EoEtrue_vs_EtaWidth_EE_old.resize(nBins_EtaWidth_EE);
   for(int iBin=0; iBin<nBins_EtaWidth_EE; iBin++)
       EoEtrue_vs_EtaWidth_EE_old[iBin] = new TH1F(std::string("EoEtrue_vs_EtaWidth_EE_old_"+to_string(iBin)).c_str(), std::string("EoEtrue_vs_EtaWidth_EE_old_"+to_string(iBin)).c_str(), 10000, 0., 10.);
   EoEtrue_vs_EtaWidth_EE_new.resize(nBins_EtaWidth_EE);
   for(int iBin=0; iBin<nBins_EtaWidth_EE; iBin++)
       EoEtrue_vs_EtaWidth_EE_new[iBin] = new TH1F(std::string("EoEtrue_vs_EtaWidth_EE_new_"+to_string(iBin)).c_str(), std::string("EoEtrue_vs_EtaWidth_EE_new_"+to_string(iBin)).c_str(), 10000, 0., 10.);
   
   int nBins_PhiWidth_EB = binOpts[findOption(std::string("PhiWidthBins_Barrel"),binOpts)].second[0]; 
   int nBins_PhiWidth_EE = binOpts[findOption(std::string("PhiWidthBins_Endcap"),binOpts)].second[0];
   
   EoEtrue_vs_PhiWidth_EB_old.resize(nBins_PhiWidth_EB);
   for(int iBin=0; iBin<nBins_PhiWidth_EB; iBin++)
       EoEtrue_vs_PhiWidth_EB_old[iBin] = new TH1F(std::string("EoEtrue_vs_PhiWidth_EB_old_"+to_string(iBin)).c_str(), std::string("EoEtrue_vs_PhiWidth_EB_old_"+to_string(iBin)).c_str(), 10000, 0., 10.);
   EoEtrue_vs_PhiWidth_EB_new.resize(nBins_PhiWidth_EB);
   for(int iBin=0; iBin<nBins_PhiWidth_EB; iBin++)
       EoEtrue_vs_PhiWidth_EB_new[iBin] = new TH1F(std::string("EoEtrue_vs_PhiWidth_EB_new_"+to_string(iBin)).c_str(), std::string("EoEtrue_vs_PhiWidth_EB_new_"+to_string(iBin)).c_str(), 10000, 0., 10.);
   
   
   EoEtrue_vs_PhiWidth_EE_old.resize(nBins_PhiWidth_EE);
   for(int iBin=0; iBin<nBins_PhiWidth_EE; iBin++)
       EoEtrue_vs_PhiWidth_EE_old[iBin] = new TH1F(std::string("EoEtrue_vs_PhiWidth_EE_old_"+to_string(iBin)).c_str(), std::string("EoEtrue_vs_PhiWidth_EE_old_"+to_string(iBin)).c_str(), 10000, 0., 10.);
   EoEtrue_vs_PhiWidth_EE_new.resize(nBins_PhiWidth_EE);
   for(int iBin=0; iBin<nBins_PhiWidth_EE; iBin++)
       EoEtrue_vs_PhiWidth_EE_new[iBin] = new TH1F(std::string("EoEtrue_vs_PhiWidth_EE_new_"+to_string(iBin)).c_str(), std::string("EoEtrue_vs_PhiWidth_EE_new_"+to_string(iBin)).c_str(), 10000, 0., 10.);
...
void drawPlots(std::string fitFunction_, string superClusterRef_, string superClusterVal_)
{
   ...
   drawGraph(gr_EoEtrue_vs_Et_EB_old.first, gr_EoEtrue_vs_Et_EB_new.first, std::string("caloParticle_Et (GeV)"), std::string("#mu"), std::string("EoEtrue_vs_caloEt_EB_Mean"), superClusterRef_, superClusterVal_,0.97,1.03);
   ...
   drawGraph(gr_EoEtrue_vs_Et_EE_old.first, gr_EoEtrue_vs_Et_EE_new.first, std::string("caloParticle_Et (GeV)"), std::string("#mu"), std::string("EoEtrue_vs_caloEt_EE_Mean"), superClusterRef_, superClusterVal_,0.97,1.03);
   ...
   drawGraph(gr_EoEtrue_vs_Energy_EB_old.first, gr_EoEtrue_vs_Energy_EB_new.first, std::string("caloParticle_Energy (GeV)"), std::string("#mu"), std::string("EoEtrue_vs_caloEnergy_EB_Mean"), superClusterRef_, superClusterVal_,0.97,1.03);
   ...
   drawGraph(gr_EoEtrue_vs_Energy_EE_old.first, gr_EoEtrue_vs_Energy_EE_new.first, std::string("caloParticle_Energy (GeV)"), std::string("#mu"), std::string("EoEtrue_vs_caloEnergy_EE_Mean"), superClusterRef_, superClusterVal_,0.97,1.03);
   ...
   //eff ratios
   h_Eta_Calo_old->Divide(h_Eta_Calo_Denum);
   h_Eta_Calo_new->Divide(h_Eta_Calo_Denum);
   h_Et_Calo_EB_old->Divide(h_Et_Calo_EB_Denum);
   h_Et_Calo_EB_new->Divide(h_Et_Calo_EB_Denum);
   h_Et_Calo_EE_old->Divide(h_Et_Calo_EE_Denum);
   h_Et_Calo_EE_new->Divide(h_Et_Calo_EE_Denum);
...
void savePlots()
{
   ...
   TFile *plotFile = new TFile("SCAlgoPlots_LocalSetParams.root", "RECREATE");
   plotFile->cd();
   ...
   //DEFINE HISTOGRAMS
      ...
      //Total
      h_calo_pfClusters_eta->Draw();
      h_calo_pfClusters_eta->Write();


      h_sc_pfClusters_eta_new->Draw();
      h_sc_pfClusters_eta_new->Write();


      h_sc_pfClusters_eta_old->Draw();
      h_sc_pfClusters_eta_old->Write();

      h_sc_pfClusters_caloInSC_new->Draw();
      h_sc_pfClusters_caloInSC_new->Write();

      h_sc_pfClusters_caloInSC_old->Draw();
      h_sc_pfClusters_caloInSC_old->Write();
      ...
      h_Eta_SCGen_old->Draw();
      h_Eta_SCGen_old->Write();

      h_Eta_SCGen_new->Draw();
      h_Eta_SCGen_new->Write();

      h_Eta_SC_old_dr->Draw();
      h_Eta_SC_old_dr->Write();

      h_Eta_SC_new_dr->Draw();
      h_Eta_SC_new_dr->Write();

      h_Eta_SCGen_old_dr->Draw();
      h_Eta_SCGen_old_dr->Write();

      h_Eta_SCGen_new_dr->Draw();
      h_Eta_SCGen_new_dr->Write();





      h_Energy_EB_old->Draw();
      h_Energy_EB_old->Write();
      h_Energy_EE_old->Draw();
      h_Energy_EE_old->Write();
      h_Energy_EB_new->Draw();
      h_Energy_EB_new->Write();
      h_Energy_EE_new->Draw();
      h_Energy_EE_new->Write();
      h_Et_EB_old->Draw();
      h_Et_EB_old->Write();
      h_Et_EE_old->Draw();
      h_Et_EE_old->Write();
      ...
      h_Phi_EE_new->Draw();
      h_Phi_EE_new->Write();
      h_EtaWidth_EB_old->Draw();
      h_EtaWidth_EB_old->Write();
      h_EtaWidth_EE_old->Draw();
      h_EtaWidth_EE_old->Write();
      h_EtaWidth_EB_new->Draw();
      h_EtaWidth_EB_new->Write();
      h_EtaWidth_EE_new->Draw();
      h_EtaWidth_EE_new->Write();
      h_PhiWidth_EB_old->Draw(); h_PhiWidth_EB_old->Write();
      h_PhiWidth_EE_old->Draw(); h_PhiWidth_EE_old->Write();
      h_PhiWidth_EB_new->Draw(); h_PhiWidth_EB_new->Write();
      h_PhiWidth_EE_new->Draw(); h_PhiWidth_EE_new->Write();
      h_nPFClusters_old->Draw(); h_nPFClusters_old->Write();
      h_nPFClusters_new->Draw(); h_nPFClusters_new->Write();
      h_nPFClusters_EB_old->Draw(); h_nPFClusters_EB_old->Write();
      h_nPFClusters_EE_old->Draw(); h_nPFClusters_EE_old->Write();
      h_nPFClusters_EB_new->Draw(); h_nPFClusters_EB_new->Write();
      h_nPFClusters_EE_new->Draw(); h_nPFClusters_EE_new->Write();
      h_R9_EB_old->Draw(); h_R9_EB_old->Write();
      h_R9_EE_old->Draw(); h_R9_EE_old->Write();
      h_R9_EB_new->Draw(); h_R9_EB_new->Write();
      h_R9_EE_new->Draw(); h_R9_EE_new->Write();
      h_full5x5_R9_EB_old->Draw(); h_full5x5_R9_EB_old->Write();
      h_full5x5_R9_EE_old->Draw(); h_full5x5_R9_EE_old->Write();
      h_full5x5_R9_EB_new->Draw(); h_full5x5_R9_EB_new->Write();
      h_full5x5_R9_EE_new->Draw(); h_full5x5_R9_EE_new->Write();
      h_sigmaIetaIeta_EB_old->Draw(); h_sigmaIetaIeta_EB_old->Write();
      h_sigmaIetaIeta_EE_old->Draw(); h_sigmaIetaIeta_EE_old->Write();
      h_sigmaIetaIeta_EB_new->Draw(); h_sigmaIetaIeta_EB_new->Write();
      h_sigmaIetaIeta_EE_new->Draw(); h_sigmaIetaIeta_EE_new->Write();
      h_full5x5_sigmaIetaIeta_EB_old->Draw(); h_full5x5_sigmaIetaIeta_EB_old->Write();
      h_full5x5_sigmaIetaIeta_EE_old->Draw(); h_full5x5_sigmaIetaIeta_EE_old->Write();
      h_full5x5_sigmaIetaIeta_EB_new->Draw(); h_full5x5_sigmaIetaIeta_EB_new->Write();
      h_full5x5_sigmaIetaIeta_EE_new->Draw(); h_full5x5_sigmaIetaIeta_EE_new->Write();
      h_sigmaIetaIphi_EB_old->Draw(); h_sigmaIetaIphi_EB_old->Write();
      h_sigmaIetaIphi_EE_old->Draw(); h_sigmaIetaIphi_EE_old->Write();
      h_sigmaIetaIphi_EB_new->Draw(); h_sigmaIetaIphi_EB_new->Write();
      h_sigmaIetaIphi_EE_new->Draw(); h_sigmaIetaIphi_EE_new->Write();
      h_full5x5_sigmaIetaIphi_EB_old->Draw(); h_full5x5_sigmaIetaIphi_EB_old->Write();
      h_full5x5_sigmaIetaIphi_EE_old->Draw(); h_full5x5_sigmaIetaIphi_EE_old->Write();
      h_full5x5_sigmaIetaIphi_EB_new->Draw(); h_full5x5_sigmaIetaIphi_EB_new->Write();
      h_full5x5_sigmaIetaIphi_EE_new->Draw(); h_full5x5_sigmaIetaIphi_EE_new->Write();
      h_sigmaIphiIphi_EB_old->Draw(); h_sigmaIphiIphi_EB_old->Write();
      h_sigmaIphiIphi_EE_old->Draw(); h_sigmaIphiIphi_EE_old->Write();
      h_sigmaIphiIphi_EB_new->Draw(); h_sigmaIphiIphi_EB_new->Write();
      h_sigmaIphiIphi_EE_new->Draw(); h_sigmaIphiIphi_EE_new->Write();
      h_full5x5_sigmaIphiIphi_EB_old->Draw(); h_full5x5_sigmaIphiIphi_EB_old->Write();
      h_full5x5_sigmaIphiIphi_EE_old->Draw(); h_full5x5_sigmaIphiIphi_EE_old->Write();
      h_full5x5_sigmaIphiIphi_EB_new->Draw(); h_full5x5_sigmaIphiIphi_EB_new->Write();
      h_full5x5_sigmaIphiIphi_EE_new->Draw(); h_full5x5_sigmaIphiIphi_EE_new->Write();
      //seed matched plots
      h_Energy_EB_seedMatched_old->Draw(); h_Energy_EB_seedMatched_old->Write();
      h_Energy_EE_seedMatched_old->Draw(); h_Energy_EE_seedMatched_old->Write();
      h_Energy_EB_seedMatched_new->Draw(); h_Energy_EB_seedMatched_new->Write();
      h_Energy_EE_seedMatched_new->Draw(); h_Energy_EE_seedMatched_new->Write();
      h_Et_EB_seedMatched_old->Draw(); h_Et_EB_seedMatched_old->Write();
      h_Et_EE_seedMatched_old->Draw(); h_Et_EE_seedMatched_old->Write();
      h_Et_EB_seedMatched_new->Draw(); h_Et_EB_seedMatched_new->Write();
      h_Et_EE_seedMatched_new->Draw(); h_Et_EE_seedMatched_new->Write();
      h_Eta_seedMatched_old->Draw(); h_Eta_seedMatched_old->Write();
      h_Eta_seedMatched_new->Draw(); h_Eta_seedMatched_new->Write();
      h_Phi_EB_seedMatched_old->Draw(); h_Phi_EB_seedMatched_old->Write();
      h_Phi_EE_seedMatched_old->Draw(); h_Phi_EE_seedMatched_old->Write();
      h_Phi_EB_seedMatched_new->Draw(); h_Phi_EB_seedMatched_new->Write();
      h_Phi_EE_seedMatched_new->Draw(); h_Phi_EE_seedMatched_new->Write();
      h_EtaWidth_EB_seedMatched_old->Draw(); h_EtaWidth_EB_seedMatched_old->Write();
      h_EtaWidth_EE_seedMatched_old->Draw();h_EtaWidth_EE_seedMatched_old->Write();
      h_EtaWidth_EB_seedMatched_new->Draw(); h_EtaWidth_EB_seedMatched_new->Write();
      h_EtaWidth_EE_seedMatched_new->Draw(); h_EtaWidth_EE_seedMatched_new->Write();
      h_PhiWidth_EB_seedMatched_old->Draw(); h_PhiWidth_EB_seedMatched_old->Write();
      h_PhiWidth_EE_seedMatched_old->Draw(); h_PhiWidth_EE_seedMatched_old->Write();
      h_PhiWidth_EB_seedMatched_new->Draw(); h_PhiWidth_EB_seedMatched_new->Write();
      h_PhiWidth_EE_seedMatched_new->Draw(); h_PhiWidth_EE_seedMatched_new->Write();
      h_nPFClusters_seedMatched_old->Draw(); h_nPFClusters_seedMatched_old->Write();
      h_nPFClusters_seedMatched_new->Draw(); h_nPFClusters_seedMatched_new->Write();
      h_nPFClusters_EB_seedMatched_old->Draw(); h_nPFClusters_EB_seedMatched_old->Write();
      h_nPFClusters_EE_seedMatched_old->Draw(); h_nPFClusters_EE_seedMatched_old->Write();
      h_nPFClusters_EB_seedMatched_new->Draw(); h_nPFClusters_EB_seedMatched_new->Write();
      h_nPFClusters_EE_seedMatched_new->Draw(); h_nPFClusters_EE_seedMatched_new->Write();
      h_R9_EB_seedMatched_old->Draw(); h_R9_EB_seedMatched_old->Write();
      h_R9_EE_seedMatched_old->Draw(); h_R9_EE_seedMatched_old->Write();
      h_R9_EB_seedMatched_new->Draw(); h_R9_EB_seedMatched_new->Write();
      h_R9_EE_seedMatched_new->Draw(); h_R9_EE_seedMatched_new->Write();
      h_full5x5_R9_EB_seedMatched_old->Draw(); h_full5x5_R9_EB_seedMatched_old->Write();
      h_full5x5_R9_EE_seedMatched_old->Draw(); h_full5x5_R9_EE_seedMatched_old->Write();
      h_full5x5_R9_EB_seedMatched_new->Draw(); h_full5x5_R9_EB_seedMatched_new->Write();
      h_full5x5_R9_EE_seedMatched_new->Draw(); h_full5x5_R9_EE_seedMatched_new->Write();
      h_sigmaIetaIeta_EB_seedMatched_old->Draw(); h_sigmaIetaIeta_EB_seedMatched_old->Write();
      h_sigmaIetaIeta_EE_seedMatched_old->Draw(); h_sigmaIetaIeta_EE_seedMatched_old->Write();
      h_sigmaIetaIeta_EB_seedMatched_new->Draw(); h_sigmaIetaIeta_EB_seedMatched_new->Write();
      h_sigmaIetaIeta_EE_seedMatched_new->Draw(); h_sigmaIetaIeta_EE_seedMatched_new->Write();
      h_full5x5_sigmaIetaIeta_EB_seedMatched_old->Draw(); h_full5x5_sigmaIetaIeta_EB_seedMatched_old->Write();
      h_full5x5_sigmaIetaIeta_EE_seedMatched_old->Draw(); h_full5x5_sigmaIetaIeta_EE_seedMatched_old->Write();
      h_full5x5_sigmaIetaIeta_EB_seedMatched_new->Draw(); h_full5x5_sigmaIetaIeta_EB_seedMatched_new->Write();
      h_full5x5_sigmaIetaIeta_EE_seedMatched_new->Draw(); h_full5x5_sigmaIetaIeta_EE_seedMatched_new->Write();
      h_sigmaIetaIphi_EB_seedMatched_old->Draw(); h_sigmaIetaIphi_EB_seedMatched_old->Write();
      h_sigmaIetaIphi_EE_seedMatched_old->Draw(); h_sigmaIetaIphi_EE_seedMatched_old->Write();
      h_sigmaIetaIphi_EB_seedMatched_new->Draw(); h_sigmaIetaIphi_EB_seedMatched_new->Write();
      h_sigmaIetaIphi_EE_seedMatched_new->Draw(); h_sigmaIetaIphi_EE_seedMatched_new->Write();
      h_full5x5_sigmaIetaIphi_EB_seedMatched_old->Draw(); h_full5x5_sigmaIetaIphi_EB_seedMatched_old->Write();
      h_full5x5_sigmaIetaIphi_EE_seedMatched_old->Draw(); h_full5x5_sigmaIetaIphi_EE_seedMatched_old->Write();
      h_full5x5_sigmaIetaIphi_EB_seedMatched_new->Draw(); h_full5x5_sigmaIetaIphi_EB_seedMatched_new->Write();
      h_full5x5_sigmaIetaIphi_EE_seedMatched_new->Draw(); h_full5x5_sigmaIetaIphi_EE_seedMatched_new->Write();
      h_sigmaIphiIphi_EB_seedMatched_old->Draw(); h_sigmaIphiIphi_EB_seedMatched_old->Write();
      h_sigmaIphiIphi_EE_seedMatched_old->Draw(); h_sigmaIphiIphi_EE_seedMatched_old->Write();
      h_sigmaIphiIphi_EB_seedMatched_new->Draw(); h_sigmaIphiIphi_EB_seedMatched_new->Write();
      h_sigmaIphiIphi_EE_seedMatched_new->Draw(); h_sigmaIphiIphi_EE_seedMatched_new->Write();
      h_full5x5_sigmaIphiIphi_EB_seedMatched_old->Draw(); h_full5x5_sigmaIphiIphi_EB_seedMatched_old->Write();
      h_full5x5_sigmaIphiIphi_EE_seedMatched_old->Draw(); h_full5x5_sigmaIphiIphi_EE_seedMatched_old->Write();
      h_full5x5_sigmaIphiIphi_EB_seedMatched_new->Draw(); h_full5x5_sigmaIphiIphi_EB_seedMatched_new->Write();
      h_full5x5_sigmaIphiIphi_EE_seedMatched_new->Draw(); h_full5x5_sigmaIphiIphi_EE_seedMatched_new->Write();

      //caloMatched
      h_Energy_EB_caloMatched_old->Draw();       h_Energy_EB_caloMatched_old->Write();
      h_Energy_EE_caloMatched_old->Draw();       h_Energy_EE_caloMatched_old->Write();
      h_Energy_EB_caloMatched_new->Draw();       h_Energy_EB_caloMatched_new->Write();
      h_Energy_EE_caloMatched_new->Draw();       h_Energy_EE_caloMatched_new->Write();
      h_EoEtrue_EB_old->Draw();       h_EoEtrue_EB_old->Write();
      h_EoEtrue_EE_old->Draw();       h_EoEtrue_EE_old->Write();
      h_EoEtrue_EB_new->Draw();       h_EoEtrue_EB_new->Write();
      h_EoEtrue_EE_new->Draw();       h_EoEtrue_EE_new->Write();
      h_EoEgen_EB_old->Draw();       h_EoEgen_EB_old->Write();
      h_EoEgen_EE_old->Draw();       h_EoEgen_EE_old->Write();
      h_EoEgen_EB_new->Draw();       h_EoEgen_EB_new->Write();
      h_EoEgen_EE_new->Draw();       h_EoEgen_EE_new->Write();
      h_Et_EB_caloMatched_old->Draw();       h_Et_EB_caloMatched_old->Write();
      h_Et_EE_caloMatched_old->Draw();       h_Et_EE_caloMatched_old->Write();
      h_Et_EB_caloMatched_new->Draw();       h_Et_EB_caloMatched_new->Write();
      h_Et_EE_caloMatched_new->Draw();       h_Et_EE_caloMatched_new->Write();
      h_Eta_caloMatched_old->Draw();       h_Eta_caloMatched_old->Write();
      h_Eta_caloMatched_new->Draw();       h_Eta_caloMatched_new->Write();
      h_Phi_EB_caloMatched_old->Draw();       h_Phi_EB_caloMatched_old->Write();
      h_Phi_EE_caloMatched_old->Draw();       h_Phi_EE_caloMatched_old->Write();
      h_Phi_EB_caloMatched_new->Draw();       h_Phi_EB_caloMatched_new->Write();
      h_Phi_EE_caloMatched_new->Draw();       h_Phi_EE_caloMatched_new->Write();
      h_EtaWidth_EB_caloMatched_old->Draw();       h_EtaWidth_EB_caloMatched_old->Write();
      h_EtaWidth_EE_caloMatched_old->Draw();       h_EtaWidth_EE_caloMatched_old->Write();
      h_EtaWidth_EB_caloMatched_new->Draw();       h_EtaWidth_EB_caloMatched_new->Write();
      h_EtaWidth_EE_caloMatched_new->Draw();       h_EtaWidth_EE_caloMatched_new->Write();
      h_PhiWidth_EB_caloMatched_old->Draw();       h_PhiWidth_EB_caloMatched_old->Write();
      h_PhiWidth_EE_caloMatched_old->Draw();       h_PhiWidth_EE_caloMatched_old->Write();
      h_PhiWidth_EB_caloMatched_new->Draw();       h_PhiWidth_EB_caloMatched_new->Write();
      h_PhiWidth_EE_caloMatched_new->Draw();       h_PhiWidth_EE_caloMatched_new->Write();
      h_nPFClusters_caloMatched_old->Draw();       h_nPFClusters_caloMatched_old->Write();
      h_nPFClusters_caloMatched_new->Draw();       h_nPFClusters_caloMatched_new->Write();
      h_nPFClusters_EB_caloMatched_old->Draw();       h_nPFClusters_EB_caloMatched_old->Write();
      h_nPFClusters_EE_caloMatched_old->Draw();       h_nPFClusters_EE_caloMatched_old->Write();
      h_nPFClusters_EB_caloMatched_new->Draw();       h_nPFClusters_EB_caloMatched_new->Write();
      h_nPFClusters_EE_caloMatched_new->Draw();       h_nPFClusters_EE_caloMatched_new->Write();
      h_R9_EB_caloMatched_old->Draw();       h_R9_EB_caloMatched_old->Write();
      h_R9_EE_caloMatched_old->Draw();       h_R9_EE_caloMatched_old->Write();
      h_R9_EB_caloMatched_new->Draw();       h_R9_EB_caloMatched_new->Write();
      h_R9_EE_caloMatched_new->Draw();       h_R9_EE_caloMatched_new->Write();
      h_full5x5_R9_EB_caloMatched_old->Draw();       h_full5x5_R9_EB_caloMatched_old->Write();
      h_full5x5_R9_EE_caloMatched_old->Draw();       h_full5x5_R9_EE_caloMatched_old->Write();
      h_full5x5_R9_EB_caloMatched_new->Draw();       h_full5x5_R9_EB_caloMatched_new->Write();
      h_full5x5_R9_EE_caloMatched_new->Draw();       h_full5x5_R9_EE_caloMatched_new->Write();
      h_sigmaIetaIeta_EB_caloMatched_old->Draw();       h_sigmaIetaIeta_EB_caloMatched_old->Write();
      h_sigmaIetaIeta_EE_caloMatched_old->Draw();       h_sigmaIetaIeta_EE_caloMatched_old->Write();
      h_sigmaIetaIeta_EB_caloMatched_new->Draw();       h_sigmaIetaIeta_EB_caloMatched_new->Write();
      h_sigmaIetaIeta_EE_caloMatched_new->Draw();       h_sigmaIetaIeta_EE_caloMatched_new->Write();
      h_full5x5_sigmaIetaIeta_EB_caloMatched_old->Draw();       h_full5x5_sigmaIetaIeta_EB_caloMatched_old->Write();
      h_full5x5_sigmaIetaIeta_EE_caloMatched_old->Draw();       h_full5x5_sigmaIetaIeta_EE_caloMatched_old->Write();
      h_full5x5_sigmaIetaIeta_EB_caloMatched_new->Draw();       h_full5x5_sigmaIetaIeta_EB_caloMatched_new->Write();
      h_full5x5_sigmaIetaIeta_EE_caloMatched_new->Draw();       h_full5x5_sigmaIetaIeta_EE_caloMatched_new->Write();
      h_sigmaIetaIphi_EB_caloMatched_old->Draw();       h_sigmaIetaIphi_EB_caloMatched_old->Write();
      h_sigmaIetaIphi_EE_caloMatched_old->Draw();       h_sigmaIetaIphi_EE_caloMatched_old->Write();
      h_sigmaIetaIphi_EB_caloMatched_new->Draw();       h_sigmaIetaIphi_EB_caloMatched_new->Write();
      h_sigmaIetaIphi_EE_caloMatched_new->Draw();       h_sigmaIetaIphi_EE_caloMatched_new->Write();
      h_full5x5_sigmaIetaIphi_EB_caloMatched_old->Draw();       h_full5x5_sigmaIetaIphi_EB_caloMatched_old->Write();
      h_full5x5_sigmaIetaIphi_EE_caloMatched_old->Draw();       h_full5x5_sigmaIetaIphi_EE_caloMatched_old->Write();
      h_full5x5_sigmaIetaIphi_EB_caloMatched_new->Draw();       h_full5x5_sigmaIetaIphi_EB_caloMatched_new->Write();
      h_full5x5_sigmaIetaIphi_EE_caloMatched_new->Draw();       h_full5x5_sigmaIetaIphi_EE_caloMatched_new->Write();
      h_sigmaIphiIphi_EB_caloMatched_old->Draw();       h_sigmaIphiIphi_EB_caloMatched_old->Write();
      h_sigmaIphiIphi_EE_caloMatched_old->Draw();       h_sigmaIphiIphi_EE_caloMatched_old->Write();
      h_sigmaIphiIphi_EB_caloMatched_new->Draw();       h_sigmaIphiIphi_EB_caloMatched_new->Write();
      h_sigmaIphiIphi_EE_caloMatched_new->Draw();       h_sigmaIphiIphi_EE_caloMatched_new->Write();
      h_full5x5_sigmaIphiIphi_EB_caloMatched_old->Draw();       h_full5x5_sigmaIphiIphi_EB_caloMatched_old->Write();
      h_full5x5_sigmaIphiIphi_EE_caloMatched_old->Draw();       h_full5x5_sigmaIphiIphi_EE_caloMatched_old->Write();
      h_full5x5_sigmaIphiIphi_EB_caloMatched_new->Draw();       h_full5x5_sigmaIphiIphi_EB_caloMatched_new->Write();
      h_full5x5_sigmaIphiIphi_EE_caloMatched_new->Draw();       h_full5x5_sigmaIphiIphi_EE_caloMatched_new->Write();
 
      //caloMatched && seedMatched       //caloMatched && seedMatched
      h_EoEtrue_EB_seedMatched_old->Draw();       h_EoEtrue_EB_seedMatched_old->Write();
      h_EoEtrue_EE_seedMatched_old->Draw();       h_EoEtrue_EE_seedMatched_old->Write();
      h_EoEtrue_EB_seedMatched_new->Draw();       h_EoEtrue_EB_seedMatched_new->Write();
      h_EoEtrue_EE_seedMatched_new->Draw();       h_EoEtrue_EE_seedMatched_new->Write();
      h_EoEgen_EB_seedMatched_old->Draw();       h_EoEgen_EB_seedMatched_old->Write();
      h_EoEgen_EE_seedMatched_old->Draw();       h_EoEgen_EE_seedMatched_old->Write();
      h_EoEgen_EB_seedMatched_new->Draw();       h_EoEgen_EB_seedMatched_new->Write();
      h_EoEgen_EE_seedMatched_new->Draw();       h_EoEgen_EE_seedMatched_new->Write();

      //caloUnmatched
      h_Energy_EB_caloUnmatched_old->Draw(); h_Energy_EB_caloUnmatched_old->Write();
      h_Energy_EE_caloUnmatched_old->Draw(); h_Energy_EE_caloUnmatched_old->Write();
      h_Energy_EB_caloUnmatched_new->Draw(); h_Energy_EB_caloUnmatched_new->Write();
      h_Energy_EE_caloUnmatched_new->Draw(); h_Energy_EE_caloUnmatched_new->Write();
      h_Et_EB_caloUnmatched_old->Draw(); h_Et_EB_caloUnmatched_old->Write();
      h_Et_EE_caloUnmatched_old->Draw(); h_Et_EE_caloUnmatched_old->Write();
      h_Et_EB_caloUnmatched_new->Draw();       h_Et_EB_caloUnmatched_new->Write();
      h_Et_EE_caloUnmatched_new->Draw();       h_Et_EE_caloUnmatched_new->Write();
      h_Eta_caloUnmatched_old->Draw();       h_Eta_caloUnmatched_old->Write();
      h_Eta_caloUnmatched_new->Draw();       h_Eta_caloUnmatched_new->Write();
      h_Phi_EB_caloUnmatched_old->Draw();       h_Phi_EB_caloUnmatched_old->Write();
      h_Phi_EE_caloUnmatched_old->Draw();       h_Phi_EE_caloUnmatched_old->Write();
      h_Phi_EB_caloUnmatched_new->Draw();       h_Phi_EB_caloUnmatched_new->Write();
      h_Phi_EE_caloUnmatched_new->Draw();       h_Phi_EE_caloUnmatched_new->Write();
      h_EtaWidth_EB_caloUnmatched_old->Draw();       h_EtaWidth_EB_caloUnmatched_old->Write();
      h_EtaWidth_EE_caloUnmatched_old->Draw();       h_EtaWidth_EE_caloUnmatched_old->Write();
      h_EtaWidth_EB_caloUnmatched_new->Draw();       h_EtaWidth_EB_caloUnmatched_new->Write();
      h_EtaWidth_EE_caloUnmatched_new->Draw();       h_EtaWidth_EE_caloUnmatched_new->Write();
      h_PhiWidth_EB_caloUnmatched_old->Draw();       h_PhiWidth_EB_caloUnmatched_old->Write();
      h_PhiWidth_EE_caloUnmatched_old->Draw();       h_PhiWidth_EE_caloUnmatched_old->Write();
      h_PhiWidth_EB_caloUnmatched_new->Draw();       h_PhiWidth_EB_caloUnmatched_new->Write();
      h_PhiWidth_EE_caloUnmatched_new->Draw();       h_PhiWidth_EE_caloUnmatched_new->Write();
      h_nPFClusters_caloUnmatched_old->Draw();       h_nPFClusters_caloUnmatched_old->Write();
      h_nPFClusters_caloUnmatched_new->Draw();       h_nPFClusters_caloUnmatched_new->Write();
      h_nPFClusters_EB_caloUnmatched_old->Draw();       h_nPFClusters_EB_caloUnmatched_old->Write();
      h_nPFClusters_EE_caloUnmatched_old->Draw();       h_nPFClusters_EE_caloUnmatched_old->Write();
      h_nPFClusters_EB_caloUnmatched_new->Draw();       h_nPFClusters_EB_caloUnmatched_new->Write();
      h_nPFClusters_EE_caloUnmatched_new->Draw();       h_nPFClusters_EE_caloUnmatched_new->Write();
      h_R9_EB_caloUnmatched_old->Draw();       h_R9_EB_caloUnmatched_old->Write();
      h_R9_EE_caloUnmatched_old->Draw();       h_R9_EE_caloUnmatched_old->Write();
      h_R9_EB_caloUnmatched_new->Draw();       h_R9_EB_caloUnmatched_new->Write();
      h_R9_EE_caloUnmatched_new->Draw();       h_R9_EE_caloUnmatched_new->Write();
      h_full5x5_R9_EB_caloUnmatched_old->Draw();       h_full5x5_R9_EB_caloUnmatched_old->Write();
      h_full5x5_R9_EE_caloUnmatched_old->Draw();       h_full5x5_R9_EE_caloUnmatched_old->Write();
      h_full5x5_R9_EB_caloUnmatched_new->Draw();       h_full5x5_R9_EB_caloUnmatched_new->Write();
      h_full5x5_R9_EE_caloUnmatched_new->Draw();       h_full5x5_R9_EE_caloUnmatched_new->Write();
      h_sigmaIetaIeta_EB_caloUnmatched_old->Draw();       h_sigmaIetaIeta_EB_caloUnmatched_old->Write();
      h_sigmaIetaIeta_EE_caloUnmatched_old->Draw();       h_sigmaIetaIeta_EE_caloUnmatched_old->Write();
      h_sigmaIetaIeta_EB_caloUnmatched_new->Draw();       h_sigmaIetaIeta_EB_caloUnmatched_new->Write();
      h_sigmaIetaIeta_EE_caloUnmatched_new->Draw();       h_sigmaIetaIeta_EE_caloUnmatched_new->Write();
      h_full5x5_sigmaIetaIeta_EB_caloUnmatched_old->Draw();       h_full5x5_sigmaIetaIeta_EB_caloUnmatched_old->Write();
      h_full5x5_sigmaIetaIeta_EE_caloUnmatched_old->Draw();       h_full5x5_sigmaIetaIeta_EE_caloUnmatched_old->Write();
      h_full5x5_sigmaIetaIeta_EB_caloUnmatched_new->Draw();       h_full5x5_sigmaIetaIeta_EB_caloUnmatched_new->Write();
      h_full5x5_sigmaIetaIeta_EE_caloUnmatched_new->Draw();       h_full5x5_sigmaIetaIeta_EE_caloUnmatched_new->Write();
      h_sigmaIetaIphi_EB_caloUnmatched_old->Draw();       h_sigmaIetaIphi_EB_caloUnmatched_old->Write();
      h_sigmaIetaIphi_EE_caloUnmatched_old->Draw();       h_sigmaIetaIphi_EE_caloUnmatched_old->Write();
      h_sigmaIetaIphi_EB_caloUnmatched_new->Draw();       h_sigmaIetaIphi_EB_caloUnmatched_new->Write();
      h_sigmaIetaIphi_EE_caloUnmatched_new->Draw();       h_sigmaIetaIphi_EE_caloUnmatched_new->Write();
      h_full5x5_sigmaIetaIphi_EB_caloUnmatched_old->Draw();       h_full5x5_sigmaIetaIphi_EB_caloUnmatched_old->Write();
      h_full5x5_sigmaIetaIphi_EE_caloUnmatched_old->Draw();       h_full5x5_sigmaIetaIphi_EE_caloUnmatched_old->Write();
      h_full5x5_sigmaIetaIphi_EB_caloUnmatched_new->Draw();       h_full5x5_sigmaIetaIphi_EB_caloUnmatched_new->Write();
      h_full5x5_sigmaIetaIphi_EE_caloUnmatched_new->Draw();       h_full5x5_sigmaIetaIphi_EE_caloUnmatched_new->Write();
      h_sigmaIphiIphi_EB_caloUnmatched_old->Draw();       h_sigmaIphiIphi_EB_caloUnmatched_old->Write();
      h_sigmaIphiIphi_EE_caloUnmatched_old->Draw();       h_sigmaIphiIphi_EE_caloUnmatched_old->Write();
      h_sigmaIphiIphi_EB_caloUnmatched_new->Draw();       h_sigmaIphiIphi_EB_caloUnmatched_new->Write();
      h_sigmaIphiIphi_EE_caloUnmatched_new->Draw();       h_sigmaIphiIphi_EE_caloUnmatched_new->Write();
      h_full5x5_sigmaIphiIphi_EB_caloUnmatched_old->Draw();       h_full5x5_sigmaIphiIphi_EB_caloUnmatched_old->Write();
      h_full5x5_sigmaIphiIphi_EE_caloUnmatched_old->Draw();       h_full5x5_sigmaIphiIphi_EE_caloUnmatched_old->Write();
      h_full5x5_sigmaIphiIphi_EB_caloUnmatched_new->Draw();       h_full5x5_sigmaIphiIphi_EB_caloUnmatched_new->Write();
      h_full5x5_sigmaIphiIphi_EE_caloUnmatched_new->Draw();       h_full5x5_sigmaIphiIphi_EE_caloUnmatched_new->Write();

      //efficiencies
      h_Eta_Calo_Denum->Draw(); h_Eta_Calo_Denum->Write();
      h_Eta_Calo_old->Draw(); h_Eta_Calo_old->Write();
      h_Eta_Calo_new->Draw(); h_Eta_Calo_new->Write();
      h_Eta_Gen_Denum->Draw(); h_Eta_Gen_Denum->Write();
      h_Et_Calo_EB_Denum->Draw(); h_Et_Calo_EB_Denum->Write();
      h_Et_Calo_EB_old->Draw(); h_Et_Calo_EB_old->Write();
      h_Et_Calo_EB_new->Draw(); h_Et_Calo_EB_new->Write();
      h_Et_Calo_EE_Denum->Draw(); h_Et_Calo_EE_Denum->Write();
      h_Et_Calo_EE_old->Draw(); h_Et_Calo_EE_old->Write();
      h_Et_Calo_EE_new->Draw(); h_Et_Calo_EE_new->Write();
      eff_SuperCluster_vs_EtaCalo->Draw(); eff_SuperCluster_vs_EtaCalo->Write();
      eff_DeepSuperCluster_vs_EtaCalo->Draw();     eff_DeepSuperCluster_vs_EtaCalo->Draw(); 
      eff_SuperCluster_vs_EtCalo_EB->Draw(); eff_SuperCluster_vs_EtCalo_EB->Write();
      eff_DeepSuperCluster_vs_EtCalo_EB->Draw(); eff_DeepSuperCluster_vs_EtCalo_EB->Write();
      eff_SuperCluster_vs_EtCalo_EE->Draw(); eff_SuperCluster_vs_EtCalo_EE->Write();
      eff_DeepSuperCluster_vs_EtCalo_EE->Draw(); eff_DeepSuperCluster_vs_EtCalo_EE->Write();

      //DEFINE PROFILES
      prof_EoEtrue_vs_Eta_Calo_old->Draw(); prof_EoEtrue_vs_Eta_Calo_old->Write();
      prof_EoEtrue_vs_Eta_Calo_new->Draw(); prof_EoEtrue_vs_Eta_Calo_new->Write();
      prof_EoEtrue_vs_Eta_Seed_old->Draw(); prof_EoEtrue_vs_Eta_Seed_old->Write();
      prof_EoEtrue_vs_Eta_Seed_new->Draw(); prof_EoEtrue_vs_Eta_Seed_new->Write();
      prof_EoEtrue_vs_Et_Calo_EB_old->Draw(); prof_EoEtrue_vs_Et_Calo_EB_old->Write();
      prof_EoEtrue_vs_Et_Calo_EB_new->Draw(); prof_EoEtrue_vs_Et_Calo_EB_new->Write();
      prof_EoEtrue_vs_Et_Calo_EE_old->Draw(); prof_EoEtrue_vs_Et_Calo_EE_old->Write();
      prof_EoEtrue_vs_Et_Calo_EE_new->Draw(); prof_EoEtrue_vs_Et_Calo_EE_new->Write();
      prof_EoEtrue_vs_Et_Seed_EB_old->Draw(); prof_EoEtrue_vs_Et_Seed_EB_old->Write();
      prof_EoEtrue_vs_Et_Seed_EB_new->Draw(); prof_EoEtrue_vs_Et_Seed_EB_new->Write();
      prof_EoEtrue_vs_Et_Seed_EE_old->Draw(); prof_EoEtrue_vs_Et_Seed_EE_old->Write();
      prof_EoEtrue_vs_Et_Seed_EE_new->Draw(); prof_EoEtrue_vs_Et_Seed_EE_new->Write();
      prof_EoEtrue_vs_Energy_Calo_EB_old->Draw(); prof_EoEtrue_vs_Energy_Calo_EB_old->Write();
      prof_EoEtrue_vs_Energy_Calo_EB_new->Draw(); prof_EoEtrue_vs_Energy_Calo_EB_new->Write();
      prof_EoEtrue_vs_Energy_Calo_EE_old->Draw(); prof_EoEtrue_vs_Energy_Calo_EE_old->Write();
      prof_EoEtrue_vs_Energy_Calo_EE_new->Draw(); prof_EoEtrue_vs_Energy_Calo_EE_new->Write();
      prof_EoEtrue_vs_nVtx_EB_old->Draw(); prof_EoEtrue_vs_nVtx_EB_old->Write();
      prof_EoEtrue_vs_nVtx_EB_new->Draw(); prof_EoEtrue_vs_nVtx_EB_new->Write();
      prof_EoEtrue_vs_nVtx_EE_old->Draw(); prof_EoEtrue_vs_nVtx_EE_old->Write();
      prof_EoEtrue_vs_nVtx_EE_new->Draw(); prof_EoEtrue_vs_nVtx_EE_new->Write();
      prof_EoEtrue_vs_Rho_EB_old->Draw(); prof_EoEtrue_vs_Rho_EB_old->Write();
      prof_EoEtrue_vs_Rho_EB_new->Draw(); prof_EoEtrue_vs_Rho_EB_new->Write();
      prof_EoEtrue_vs_Rho_EE_old->Draw(); prof_EoEtrue_vs_Rho_EE_old->Write();
      prof_EoEtrue_vs_Rho_EE_new->Draw(); prof_EoEtrue_vs_Rho_EE_new->Write();
      prof_EoEgen_vs_Eta_Gen_old->Draw(); prof_EoEgen_vs_Eta_Gen_old->Write();
      prof_EoEgen_vs_Eta_Gen_new->Draw(); prof_EoEgen_vs_Eta_Gen_new->Write();
      prof_EoEgen_vs_Eta_Seed_old->Draw(); prof_EoEgen_vs_Eta_Seed_old->Write();
      prof_EoEgen_vs_Eta_Seed_new->Draw(); prof_EoEgen_vs_Eta_Seed_new->Write();
      prof_EoEgen_vs_Et_Gen_EB_old->Draw(); prof_EoEgen_vs_Et_Gen_EB_old->Write();
      prof_EoEgen_vs_Et_Gen_EB_new->Draw(); prof_EoEgen_vs_Et_Gen_EB_new->Write();
      prof_EoEgen_vs_Et_Gen_EE_old->Draw(); prof_EoEgen_vs_Et_Gen_EE_old->Write();
      prof_EoEgen_vs_Et_Gen_EE_new->Draw(); prof_EoEgen_vs_Et_Gen_EE_new->Write();
      prof_EoEgen_vs_Et_Seed_EB_old->Draw(); prof_EoEgen_vs_Et_Seed_EB_old->Write();
      prof_EoEgen_vs_Et_Seed_EB_new->Draw(); prof_EoEgen_vs_Et_Seed_EB_new->Write();
      prof_EoEgen_vs_Et_Seed_EE_old->Draw(); prof_EoEgen_vs_Et_Seed_EE_old->Write();
      prof_EoEgen_vs_Et_Seed_EE_new->Draw(); prof_EoEgen_vs_Et_Seed_EE_new->Write();
      prof_EoEgen_vs_Energy_Gen_EB_old->Draw(); prof_EoEgen_vs_Energy_Gen_EB_old->Write();
      prof_EoEgen_vs_Energy_Gen_EB_new->Draw(); prof_EoEgen_vs_Energy_Gen_EB_new->Write();
      prof_EoEgen_vs_Energy_Gen_EE_old->Draw(); prof_EoEgen_vs_Energy_Gen_EE_old->Write();
      prof_EoEgen_vs_Energy_Gen_EE_new->Draw(); prof_EoEgen_vs_Energy_Gen_EE_new->Write();
      prof_EoEgen_vs_nVtx_EB_old->Draw(); prof_EoEgen_vs_nVtx_EB_old->Write();
      prof_EoEgen_vs_nVtx_EB_new->Draw(); prof_EoEgen_vs_nVtx_EB_new->Write();
      prof_EoEgen_vs_nVtx_EE_old->Draw(); prof_EoEgen_vs_nVtx_EE_old->Write();
      prof_EoEgen_vs_nVtx_EE_new->Draw(); prof_EoEgen_vs_nVtx_EE_new->Write();
      prof_EoEgen_vs_Rho_EB_old->Draw(); prof_EoEgen_vs_Rho_EB_old->Write();
      prof_EoEgen_vs_Rho_EB_new->Draw(); prof_EoEgen_vs_Rho_EB_new->Write();
      prof_EoEgen_vs_Rho_EE_old->Draw(); prof_EoEgen_vs_Rho_EE_old->Write();
      prof_EoEgen_vs_Rho_EE_new->Draw(); prof_EoEgen_vs_Rho_EE_new->Write();


      //DEFINE HISTOGRAM VECTORS 

      for(unsigned int i=0; i<EoEtrue_vs_EtaWidth_old.size(); i++){
         EoEtrue_vs_EtaWidth_old[i]->Draw();
         EoEtrue_vs_EtaWidth_old[i]->Write();

         EoEtrue_vs_EtaWidth_new[i]->Draw();
         EoEtrue_vs_EtaWidth_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_PhiWidth_old.size(); i++){
         EoEtrue_vs_PhiWidth_old[i]->Draw();
         EoEtrue_vs_PhiWidth_old[i]->Write();

         EoEtrue_vs_PhiWidth_new[i]->Draw();
         EoEtrue_vs_PhiWidth_new[i]->Write();
      }

      for(unsigned int i=0; i<EoEtrue_vs_EtaWidth_EB_old.size(); i++){
         EoEtrue_vs_EtaWidth_EB_old[i]->Draw();
         EoEtrue_vs_EtaWidth_EB_old[i]->Write();

         EoEtrue_vs_EtaWidth_EB_new[i]->Draw();
         EoEtrue_vs_EtaWidth_EB_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_PhiWidth_EE_old.size(); i++){
         EoEtrue_vs_PhiWidth_EB_old[i]->Draw();
         EoEtrue_vs_PhiWidth_EB_old[i]->Write();

         EoEtrue_vs_PhiWidth_EB_new[i]->Draw();
         EoEtrue_vs_PhiWidth_EB_new[i]->Write();
      }

      for(unsigned int i=0; i<EoEtrue_vs_EtaWidth_EE_old.size(); i++){
         EoEtrue_vs_EtaWidth_EE_old[i]->Draw();
         EoEtrue_vs_EtaWidth_EE_old[i]->Write();

         EoEtrue_vs_EtaWidth_EE_new[i]->Draw();
         EoEtrue_vs_EtaWidth_EE_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_PhiWidth_EE_old.size(); i++){
         EoEtrue_vs_PhiWidth_EE_old[i]->Draw();
         EoEtrue_vs_PhiWidth_EE_old[i]->Write();

         EoEtrue_vs_PhiWidth_EE_new[i]->Draw();
         EoEtrue_vs_PhiWidth_EE_new[i]->Write();
      }

   cout<<"AAA"<<endl;
      for(unsigned int i=0; i<EoEtrue_vs_Eta_Calo_old.size(); i++){
         EoEtrue_vs_Eta_Calo_old[i]->Draw();
         EoEtrue_vs_Eta_Calo_old[i]->Write();

         EoEtrue_vs_Eta_Calo_new[i]->Draw();
         EoEtrue_vs_Eta_Calo_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_Eta_Seed_old.size(); i++){
         EoEtrue_vs_Eta_Seed_old[i]->Draw();
         EoEtrue_vs_Eta_Seed_old[i]->Write();

         EoEtrue_vs_Eta_Seed_new[i]->Draw();
         EoEtrue_vs_Eta_Seed_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_Et_Calo_EB_old.size(); i++){
         EoEtrue_vs_Et_Calo_EB_old[i]->Draw();
         EoEtrue_vs_Et_Calo_EB_old[i]->Write();

         EoEtrue_vs_Et_Calo_EB_new[i]->Draw();
         EoEtrue_vs_Et_Calo_EB_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_Et_Seed_EB_old.size(); i++){
         EoEtrue_vs_Et_Seed_EB_old[i]->Draw();
         EoEtrue_vs_Et_Seed_EB_old[i]->Write();

         EoEtrue_vs_Et_Seed_EB_new[i]->Draw();
         EoEtrue_vs_Et_Seed_EB_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_Energy_Calo_EB_old.size(); i++){
         EoEtrue_vs_Energy_Calo_EB_old[i]->Draw();
         EoEtrue_vs_Energy_Calo_EB_old[i]->Write();

         EoEtrue_vs_Energy_Calo_EB_new[i]->Draw();
         EoEtrue_vs_Energy_Calo_EB_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_nVtx_EB_old.size(); i++){
         EoEtrue_vs_nVtx_EB_old[i]->Draw();
         EoEtrue_vs_nVtx_EB_old[i]->Write();

         EoEtrue_vs_nVtx_EB_new[i]->Draw();
         EoEtrue_vs_nVtx_EB_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_Rho_EB_old.size(); i++){
         EoEtrue_vs_Rho_EB_old[i]->Draw();
         EoEtrue_vs_Rho_EB_old[i]->Write();

         EoEtrue_vs_Rho_EB_new[i]->Draw();
         EoEtrue_vs_Rho_EB_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_Et_Calo_EE_old.size(); i++){
         EoEtrue_vs_Et_Calo_EE_old[i]->Draw();
         EoEtrue_vs_Et_Calo_EE_old[i]->Write();

         EoEtrue_vs_Et_Calo_EE_new[i]->Draw();
         EoEtrue_vs_Et_Calo_EE_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_Et_Seed_EE_old.size(); i++){
         EoEtrue_vs_Et_Seed_EE_old[i]->Draw();
         EoEtrue_vs_Et_Seed_EE_old[i]->Write();

         EoEtrue_vs_Et_Seed_EE_new[i]->Draw();
         EoEtrue_vs_Et_Seed_EE_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_Energy_Calo_EE_old.size(); i++){
         EoEtrue_vs_Energy_Calo_EE_old[i]->Draw();
         EoEtrue_vs_Energy_Calo_EE_old[i]->Write();

         EoEtrue_vs_Energy_Calo_EE_new[i]->Draw();
         EoEtrue_vs_Energy_Calo_EE_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_nVtx_EE_old.size(); i++){
         EoEtrue_vs_nVtx_EE_old[i]->Draw();
         EoEtrue_vs_nVtx_EE_old[i]->Write();

         EoEtrue_vs_nVtx_EE_new[i]->Draw();
         EoEtrue_vs_nVtx_EE_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_Rho_EE_old.size(); i++){
         EoEtrue_vs_Rho_EE_old[i]->Draw();
         EoEtrue_vs_Rho_EE_old[i]->Write();

         EoEtrue_vs_Rho_EE_new[i]->Draw();
         EoEtrue_vs_Rho_EE_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_Eta_Gen_old.size(); i++){
         EoEgen_vs_Eta_Gen_old[i]->Draw();
         EoEgen_vs_Eta_Gen_old[i]->Write();

         EoEgen_vs_Eta_Gen_new[i]->Draw();
         EoEgen_vs_Eta_Gen_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_Eta_Seed_old.size(); i++){
         EoEgen_vs_Eta_Seed_old[i]->Draw();
         EoEgen_vs_Eta_Seed_old[i]->Write();

         EoEgen_vs_Eta_Seed_new[i]->Draw();
         EoEgen_vs_Eta_Seed_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_Et_Gen_EB_old.size(); i++){
         EoEgen_vs_Et_Gen_EB_old[i]->Draw();
         EoEgen_vs_Et_Gen_EB_old[i]->Write();

         EoEgen_vs_Et_Gen_EB_new[i]->Draw();
         EoEgen_vs_Et_Gen_EB_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_Et_Seed_EB_old.size(); i++){
         EoEgen_vs_Et_Seed_EB_old[i]->Draw();
         EoEgen_vs_Et_Seed_EB_old[i]->Write();

         EoEgen_vs_Et_Seed_EB_new[i]->Draw();
         EoEgen_vs_Et_Seed_EB_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_Energy_Gen_EB_old.size(); i++){
         EoEgen_vs_Energy_Gen_EB_old[i]->Draw();
         EoEgen_vs_Energy_Gen_EB_old[i]->Write();

         EoEgen_vs_Energy_Gen_EB_new[i]->Draw();
         EoEgen_vs_Energy_Gen_EB_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_nVtx_EB_old.size(); i++){
         EoEgen_vs_nVtx_EB_old[i]->Draw();
         EoEgen_vs_nVtx_EB_old[i]->Write();

         EoEgen_vs_nVtx_EB_new[i]->Draw();
         EoEgen_vs_nVtx_EB_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_Rho_EB_old.size(); i++){
         EoEgen_vs_Rho_EB_old[i]->Draw();
         EoEgen_vs_Rho_EB_old[i]->Write();

         EoEgen_vs_Rho_EB_new[i]->Draw();
         EoEgen_vs_Rho_EB_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_Et_Gen_EE_old.size(); i++){
         EoEgen_vs_Et_Gen_EE_old[i]->Draw();
         EoEgen_vs_Et_Gen_EE_old[i]->Write();

         EoEgen_vs_Et_Gen_EE_new[i]->Draw();
         EoEgen_vs_Et_Gen_EE_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_Et_Seed_EE_old.size(); i++){
         EoEgen_vs_Et_Seed_EE_old[i]->Draw();
         EoEgen_vs_Et_Seed_EE_old[i]->Write();

         EoEgen_vs_Et_Seed_EE_new[i]->Draw();
         EoEgen_vs_Et_Seed_EE_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_Energy_Gen_EE_old.size(); i++){
         EoEgen_vs_Energy_Gen_EE_old[i]->Draw();
         EoEgen_vs_Energy_Gen_EE_old[i]->Write();

         EoEgen_vs_Energy_Gen_EE_new[i]->Draw();
         EoEgen_vs_Energy_Gen_EE_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_nVtx_EE_old.size(); i++){
         EoEgen_vs_nVtx_EE_old[i]->Draw();
         EoEgen_vs_nVtx_EE_old[i]->Write();

         EoEgen_vs_nVtx_EE_new[i]->Draw();
         EoEgen_vs_nVtx_EE_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEgen_vs_Rho_EE_old.size(); i++){
         EoEgen_vs_Rho_EE_old[i]->Draw();
         EoEgen_vs_Rho_EE_old[i]->Write();

         EoEgen_vs_Rho_EE_new[i]->Draw();
         EoEgen_vs_Rho_EE_new[i]->Write();
      }
      for(unsigned int i=0; i<EoEtrue_vs_seedEt_seedEta_old.size(); i++){
         for(unsigned int j=0; j<EoEtrue_vs_seedEt_seedEta_old.at(i).size(); j++){
            EoEtrue_vs_seedEt_seedEta_old.at(i).at(j)->Draw();
            EoEtrue_vs_seedEt_seedEta_old.at(i).at(j)->Write();

            EoEtrue_vs_seedEt_seedEta_new.at(i).at(j)->Draw();
            EoEtrue_vs_seedEt_seedEta_new.at(i).at(j)->Write();
         }

      }

      //DEFINE RESOLUTION MAPS 
      h2_EoEtrue_Mean_old->Draw();       h2_EoEtrue_Mean_old->Write();
      h2_EoEtrue_Mean_new->Draw();       h2_EoEtrue_Mean_new->Write();
      h2_EoEtrue_Mean_Effective_old->Draw();       h2_EoEtrue_Mean_Effective_old->Write();
      h2_EoEtrue_Mean_Effective_new->Draw();       h2_EoEtrue_Mean_Effective_new->Write();
      h2_EoEtrue_Resolution_old->Draw();       h2_EoEtrue_Resolution_old->Write();
      h2_EoEtrue_Resolution_new->Draw();       h2_EoEtrue_Resolution_new->Write();
      h2_EoEtrue_Resolution_Effective_old->Draw();       h2_EoEtrue_Resolution_Effective_old->Write();
      h2_EoEtrue_Resolution_Effective_new->Draw();       h2_EoEtrue_Resolution_Effective_new->Write();
